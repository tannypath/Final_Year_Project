              ...
              <table class="table table-bordered m-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-center align-middle py-3 px-0" style="width: 40px;"><a href="cart.php?action=empty" class="shop-tooltip float-none text-light" title="" data-original-title="Clear cart"><i class="ino ion-md-trash"></i></a></th>
                  </tr>
                </thead>
    ...
    ?>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center align-middle px-0"><a href="cart.php?action=remove&code=<?php echo $item["code"]; ?>" class="shop-tooltip close float-none text-danger" title="" data-original-title="Remove" alt="Remove Item">×</a></td>
                  </tr>
